...
public class ButtonWidgetsView extends AbstractWidgetsView {
	...
	public ButtonWidgetsView() {
		...
		VerticalLayout lLayout = initLayout(lMessages, "widgets.title.page.button"); //$NON-NLS-1$
		
		lLayout.addComponent(getSubtitle(lMessages.getMessage("widgets.view.button.subtitle.button"))); //$NON-NLS-1$
		Button lButton = new Button(lMessages.getMessage("widgets.view.button.label.save")); //$NON-NLS-1$
		lButton.setDescription(lMessages.getMessage("widgets.view.button.descr.normal")); //$NON-NLS-1$
		lButton.addListener(new Listener(lMessages.getMessage("widgets.view.button.feedback.normal"))); //$NON-NLS-1$
		...
		Button lButton2 = new Button(lMessages.getMessage("widgets.view.button.label.save")); //$NON-NLS-1$
		...
		lButton2.addListener(new Listener(lMessages.getMessage("widgets.view.button.feedback.image"))); //$NON-NLS-1$
		...
		Button lButton3 = new Button(lMessages.getMessage("widgets.view.button.label.click")); //$NON-NLS-1$
		...
		lButton3.addListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent inEvent) {
				...
				getWindow().showNotification(lMessages.getMessage("widgets.view.button.feedback.disable"), Notification.TYPE_TRAY_NOTIFICATION); //$NON-NLS-1$
		...
		Button lButton4 = new Button(lMessages.getMessage("widgets.view.button.label.click")); //$NON-NLS-1$
		lButton4.setStyleName(BaseTheme.BUTTON_LINK);
		lButton4.addListener(new Listener(lMessages.getMessage("widgets.view.button.feedback.link"))); //$NON-NLS-1$
		...
		CheckBox lCheckbox = new CheckBox(lMessages.getMessage("widgets.view.button.label.click")); //$NON-NLS-1$
		lCheckbox.setImmediate(true);
		lCheckbox.addListener(new Listener(lMessages.getMessage("widgets.view.button.feedback.check"))); //$NON-NLS-1$
