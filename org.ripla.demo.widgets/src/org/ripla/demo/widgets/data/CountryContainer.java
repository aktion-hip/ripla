...
public final class CountryContainer extends BeanItemContainer<CountryBean> {
	 ...
	 */
	public static CountryContainer createData(final InputStream inInput) {
		final CountryContainer out = new CountryContainer();

		BufferedReader lReader = null;
		try {
			lReader = new BufferedReader(new InputStreamReader(inInput));
			String lLine = null;
			while ((lLine = lReader.readLine()) != null) { // NOPMD by Luthiger on 06.09.12 23:56
