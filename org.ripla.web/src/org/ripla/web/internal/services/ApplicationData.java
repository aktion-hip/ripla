...
public final class ApplicationData implements TransactionListener, Serializable {
	...
	/**
	 * Create the session data holder. This method has to be called in the
	 * application's init method.
	 * 
	 * @param inApplication
	 *            {@link Application} the application
	 */
	 ...
	 */
	@Override
	public void transactionStart(final Application inApplication,
			final Object inTransactionData) {
		instance.set(this);
	}
	 ...
	 */
	@Override
	public void transactionEnd(final Application inApplication,
			final Object inTransactionData) {
		instance.set(null);
	}

	/**
	 * Initializes the <code>ResourceBundle</code> for the i18n messages. This
	 * method has to be called in the application's init method and whenever the
	 ...
	 *            {@link User}
	 */
	public static void setUser(final User inUser) {
		instance.get().user = inUser;
	}

	/**
	 * @return {@link User} the logged in user, might be <code>null</code>, in
	 *         case of no login
	 */
	 ...
	 */
	public static void setPreferences(final PreferencesHelper inPreferences) {
	...
	/**
	 * @param inMenuMap
	 *            Map&lt;String, MenuItem> sets the map of top level menu items
	 *            to the bundle symbolic names
	 */
