...
/**
 * Base class for form creator classes. Subclasses have to implement the method {@link #createTable()}.
 * <br />
 * <p>Helper class to create Vaadin forms. Such provides form validation support and meaningful error indicators 
 * if form validation fails.</p>
 * Usage: <pre>public class MyFormCreator extends AbstractFormCreator {
