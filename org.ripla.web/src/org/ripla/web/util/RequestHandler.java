...
public class RequestHandler implements ParameterHandler {
	 ...
	 *            {@link UseCaseManager}
	 */
	public RequestHandler(final String inRequestURL,
	...
	protected static class DftRequestParameter implements IRequestParameter {
		 ...
		 * 
		 * @see
		 * org.ripla.web.util.RequestHandler.IRequestParameter#handleParameters
		 * (java.util.Map)
		 */
		@Override
		public void handleParameters(final Map<String, String[]> inParameters) {
		 ...
		 * 
		 * @see
		 * org.ripla.web.util.RequestHandler.IRequestParameter#getControllerName
		 * ()
		 */
		@Override
