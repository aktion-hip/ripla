...
/**
 * <p>The layout for the page footer.</p>
 * <p>Note: The component's styles are:<br />
 * <code>ripla-footer</code> and <code>ripla-footer-text</code></p>
 * 
 * @author Luthiger
 */
@SuppressWarnings("serial")
public class FooterHelper extends CustomComponent {
	 ...
	 * 
	 * @param inFooterText String the text to display in the footer
	 */
	private FooterHelper(String inFooterText) {
		HorizontalLayout lLayout = createLayout();
		setCompositionRoot(lLayout);
		populateLayout(lLayout, inFooterText);
	}

	private void populateLayout(HorizontalLayout inLayout, String inFooterText) {
		Label lFooterText = LabelHelper.createLabel(inFooterText, "ripla-footer-text"); //$NON-NLS-1$
	 ...
	 * 
	 * @param inHeight int the heigth in pixels
	 */
	 ...
	 * 
	 * @param inFooterText String The text to be displayed in the footer.
	 * @return {@link FooterHelper}
	 */
	public static FooterHelper createFooter(String inFooterText) {
