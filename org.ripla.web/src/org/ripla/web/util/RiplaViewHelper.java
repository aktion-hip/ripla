...
public class RiplaViewHelper {
	...
	/**
	 * Adds space to the layout:<pre>&lt;div class="spacer">&lt;/div></pre>.
	 * The amount of space added can be controlled in the application's css: 
	 * css selector <code>div.spacer</code>.
	 * 
	 * @return Component
	 */
	...
	/**
	 * Creates a layout component with the specified buttons aligned horizontally.
	 * 
	 * @param inButtons Button... the buttons to align
	 * @return {@link HorizontalLayout}
	 */
	public static HorizontalLayout createButtons(Button... inButtons) {
		...
		for (Button lButton : inButtons) {
			outButtons.addComponent(lButton);
		}
		Button lLast = inButtons[inButtons.length-1];		
	 ...
	 * 
	 * @param inContent String the text field's content
	 ...
	 */
	public static TextField createTextField(String inContent, int inWidth, Validator inValidator) {
		TextField out = new TextField(null, inContent);
		if (inValidator != null) {
	 ...
	 * 
	 * @param inLabel {@link Label} to prepare
	 * @return Label with width <code>SIZE_UNDEFINED</code>
	 */
	public static Label makeUndefinedWidth(Label inLabel) {
