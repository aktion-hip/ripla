...
public interface IToolbarActionListener {
	...
	/**
	 * Process the specified <code>IToolbarAction</code>.
	 * This method will be called when the user triggers an action on the toolbar item.
	 * 
	 * @param inAction {@link IToolbarAction}
	 */
