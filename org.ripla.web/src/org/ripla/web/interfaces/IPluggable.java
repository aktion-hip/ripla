...
/**
 * Interface for all Controllers in the framework.
 * Controllers implementing this interface have basically to implement the
 * <code>run()</code> method, which should contain all the actions of this task.
 *
 * @author Luthiger
 */
public interface IPluggable extends IEventable {
