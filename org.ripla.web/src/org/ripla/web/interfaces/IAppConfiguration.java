...
public interface IAppConfiguration {
	 ...
	 * 
	 * @return {@link IAuthenticator} the authenticator class or <code>null</code>, if the application has no login
	 */
	IAuthenticator getLoginAuthenticator();

	/**
	 * @return String welcome title displayed on the application's login page (xhtml)
	 */
	String getWelcome();
