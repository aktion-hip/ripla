...
public interface IBodyComponent {
	...
	/**
	 * Loads the controller with the specified name, i.e. runs the controller and returns 
	 * the created <code>Component</code>.
	 * 
	 * @param inControllerName String the name of the controller responsible to create the component
	...
	/**
	 * Sets the component for the context menu panel.
	 * 
	 * @param inMenuSetName String the name of the context menu set
	 */
	 ...
	 * 
	 * @param inNotification String the message to display
	 * @param inNotificationType int the message type, e.g. <code>Notification.TYPE_WARNING_MESSAGE</code>
	 */
