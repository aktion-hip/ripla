...
/**
 * Interface for all <code>Messages</code> classes to get access to the
 * localized messages provided by the bundles.
 * 
 * @author Luthiger
 */
public interface IMessages {
	...
	/**
	 * Returns the message using the specified key and arguments. This method
	 * expects messages of the form
	 * 
	 * <pre>
	 * some text to display on %s.
	 * </pre>
	 * 
	 * @param inKey
	 *            String the message key
