...
public interface IMenuExtendible extends IMenuItem {
	...
	/**
	 * @return String the extendible menu's ID. Must be unique for that bundles
	 *         that want to make contributions to this menu can look it up.
	 */
	String getMenuID();

	/**
	 * @return {@link ExtendibleMenuMarker}[] the array of markers this menu
	 *         defines to which a contribution can be attached.
	 */
