...
public class TestRiplaUserAdmin extends RiplaUserAdmin {
	...
	private MockEventProducer eventProducer;

	public TestRiplaUserAdmin() throws Exception {
		super();
	...
	*/
	 ...
	 * @throws Exception
	 */
	public static UserAdmin createUserAdmin() throws Exception {
		TestRiplaUserAdmin outUserAdmin = new TestRiplaUserAdmin();
	 ...
	 * 
	 * @param inUserName String
	 * @return {@link User}
	 * @throws Exception
	 */
	public static User createUser(String inUserName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static Group createGroup(String inGroupName) throws Exception {
